...
export const Endpoints = {
  ...
  authMisRoles: 'auth.php?action=mis_roles',
  authCambiarRol: 'auth.php?action=cambiar_rol',
  ...
  productosTiendaDetalle: (id: number): string => `productos.php?action=tienda_detalle&tienda_id=${id}`,
  productosPorTienda: (id: number): string => `productos.php?action=listar&tienda_id=${id}&limit=40`,
  ...
  metodosPagoListar: 'carrito_pagos.php?action=metodos_listar',
  metodosPagoGuardar: 'carrito_pagos.php?action=metodos_guardar',
  metodosPagoEliminar: 'carrito_pagos.php?action=metodos_eliminar',
  metodosPagoPredeterminado: 'carrito_pagos.php?action=metodos_predeterminado',
  ...
  vendedorRepartidoresCercanos: (pid: number): string => `vendedor_dashboard.php?action=repartidores_cercanos&pedido_id=${pid}`,
  vendedorAsignarRepartidor: 'vendedor_dashboard.php?action=asignar_repartidor',
  vendedorConfirmarRecogida: 'vendedor_dashboard.php?action=confirmar_recogida',
  vendedorNotificaciones: 'vendedor_dashboard.php?action=notificaciones',
  vendedorGanancias: 'vendedor_dashboard.php?action=ganancias',
  ...
  repartidorConfirmarRecogida: 'repartidor_dashboard.php?action=confirmar_recogida',
  ...
  repartidorMiPerfil: 'repartidor_dashboard.php?action=mi_perfil',
  repartidorActualizarPerfil: 'repartidor_dashboard.php?action=actualizar_perfil',
  repartidorMisResenas: 'repartidor_dashboard.php?action=mis_resenas',
  repartidorGanancias: 'repartidor_dashboard.php?action=ganancias',
  ...
  authSesionesListar:      'auth.php?action=sesiones_listar',
  authSesionesCerrar:      'auth.php?action=sesiones_cerrar',
  authSesionesCerrarOtras: 'auth.php?action=sesiones_cerrar_otras',
  authUsuariosBloqueados:  'auth.php?action=usuarios_bloqueados',
  authBloquearUsuario:     'auth.php?action=bloquear_usuario',
  authDesbloquearUsuario:  'auth.php?action=desbloquear_usuario',
  authActualizarVisibilidad: 'auth.php?action=actualizar_visibilidad',
  authEliminarCuenta:      'auth.php?action=eliminar_cuenta',
  authGuardarPushToken:    'auth.php?action=guardar_push_token',
  authActualizarIdioma:    'auth.php?action=actualizar_idioma',
  ...
  cuponValidar: 'cupones.php?action=validar',
  direccionesListar: 'direcciones.php?action=listar',
  direccionesCrear: 'direcciones.php?action=crear',
  direccionesActualizar: 'direcciones.php?action=actualizar',
  direccionesEliminar: 'direcciones.php?action=eliminar',
  direccionesMarcarPrincipal: 'direcciones.php?action=marcar_principal',
  walletSaldo: 'wallet.php?action=saldo',
  walletMovimientos: 'wallet.php?action=movimientos',
  walletSolicitarRetiro: 'wallet.php?action=solicitar_retiro',
  walletMisRetiros: 'wallet.php?action=mis_retiros',
  notificacionesListar: 'notificaciones.php?action=listar',
  notificacionesContador: 'notificaciones.php?action=contador',
  notificacionesMarcarLeida: 'notificaciones.php?action=marcar_leida',
  notificacionesMarcarTodasLeidas: 'notificaciones.php?action=marcar_todas_leidas',
} as const;
